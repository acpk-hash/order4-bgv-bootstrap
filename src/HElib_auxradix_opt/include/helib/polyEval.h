...
// num is the decomposition parameter t >= 2; higher t = fewer key-switches
// but more tensor products. Recommended: num=3 for degree ~300, num=4 for degree >1000.
void PolyEvalAsymBSGB(Ctxt& res, const Ctxt& x, NTL::ZZX f, long num = 4);
void ManyPolyEvalAsymBSGB(std::vector<Ctxt*>& res, const Ctxt& x, NTL::vec_ZZX fs, long num = 4);

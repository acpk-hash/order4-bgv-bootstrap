...
class Ctxt
{
  ...
  friend class MatMul1DExec;

public: // Exposed for Asymmetric BSGS polynomial evaluation
...
public: // Exposed for batch bootstrapping (shared-a amortization)
...
public:
  ...
  void reLinearizeInto(Ctxt& out, long keyIdx = 0, bool toNewBootKey = false);
  // key-switch this ciphertext and add the result directly into out
